  ...
  <div class="box">
    ...
    <div class="con">
      ...
      <div class="col flex">
        ...
        <span>
          <!-- 选择类检查项 -->
          <van-radio-group v-model="radio1" direction="horizontal" @change="danXuan1">
            <van-radio name="1">正常</van-radio>
            <van-radio name="2">异常</van-radio>
          </van-radio-group>
        </span>
...
export default {
  ...
  methods: {
    ...
    endAdd() {
      ...
      if (this.flag1 == 1) {
        this.checkQuery.repeat_desp = this.message1
        this.checkQuery.id = this.$route.query.detail_id
      } else {
      ...
      this.keepAxios
        ...
        .then(data => {
          ...
          if (data.data.code == 200) {
            ...
            this.$router.push('/neiBuItemList')
          } else {
            this.$toast(data.data.msg)
          }
        })

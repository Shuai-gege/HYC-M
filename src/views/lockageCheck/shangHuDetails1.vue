    ...
    <div class="con">
      ...
      <div class="col" v-if="flag == 0||flag == 2">
        <van-uploader
          ...
          :deletable="flag == 1||flag == 2?false:true"
        />
      </div>
      <div class="btn flex" v-if="flag == 1">
        <!-- <van-button type="primary" color="#A68E44" @click="up" style="padding:0 35px;">提交</van-button> -->
        <van-button type="primary" size="large" color="#A68E44" @click="yanQi">延期申请</van-button>
        <van-dialog v-model="show" title="异常提示" show-cancel-button confirm-button-color="#A68E44">
  ...
  mounted() {
    ...
    this.keepAxios
      ...
      .then(data => {
        ...
        let arrImg = this.obj.check_img.split(',')
        arrImg.forEach(item => {

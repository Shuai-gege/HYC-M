<template>
  <div class="box">
    ...
    <div class="con">
      ...
      <div class="btn flex">
        <van-button type="primary" color="#A68E44" @click="up" style="padding:0 35px;">正常</van-button>
        <van-button type="primary" color="#A68E44" @click="yiChang" style="padding:0 35px;">异常上报</van-button>
        <van-dialog
          v-model="show"
          title="确认提交检查结果吗？"
          show-cancel-button
